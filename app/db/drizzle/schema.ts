...
export type SelectProductFreightLink =
  typeof product_freight_links.$inferSelect;
export type InsertProductFreightLink =
  typeof product_freight_links.$inferInsert;
...
export type SelectFreightClassification =
  typeof freight_classifications.$inferSelect;
export type InsertFreightClassification =
  typeof freight_classifications.$inferInsert;
