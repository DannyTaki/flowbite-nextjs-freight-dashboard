...
const MailingInboxPageContent: FC<MailingInboxPageData> = function ({
  inboxMessages,
}) {
  return (
    <>
    ...
    <div className="block items-center justify-between border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800 sm:flex">
      ...
      <div className="hidden items-center space-x-0 space-y-3 sm:flex sm:space-x-3 sm:space-y-0">
        ...
        >
          ...
          <HiOutlineViewGrid className="size-7" />
        </Link>
        <button
                      ...
                      <Table.Cell className="w-4 p-4">
                        <div className="inline-flex items-center space-x-4">
                          ...
                          <button onClick={onRowStar}>
                            {starred ? (
                              <HiStar className="size-6 text-gray-500 hover:text-yellow-300 dark:text-gray-400 dark:hover:text-yellow-300" />
                            ) : (
                              <HiOutlineStar className="size-6 text-gray-500 hover:text-yellow-300 dark:text-gray-400 dark:hover:text-yellow-300" />
                            )}
                          </button>
                        </div>
                      </Table.Cell>
