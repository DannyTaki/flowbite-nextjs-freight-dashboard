...
export interface paths {
    "/rates": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["Rates.LTL.RateOnlyRequest"] | components["schemas"]["Rates.LTL.RateToBookRequest"];
                };
            };
            responses: {
    ...
    "/rates/parcel": {
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["Rates.Parcel.RateOnlyRequest"] | components["schemas"]["Rates.Parcel.RateToBookRequest"];
                };
            };
            responses: {
                /** @description The rates response echoes the elements that were included in the rate request, and also includes the shipment `id` and `rates` array. The `rates` array includes a rate object for each provider and service type combination. */
...
export interface components {
    schemas: {
        ...
        "Rates.LTL.RateOnlyRequest": components["schemas"]["Rates.LTL.Request"] & WithRequired<components["schemas"]["OriginLocation"], "originPostalCode"> & WithRequired<components["schemas"]["DestinationLocation"], "destPostalCode"> & components["schemas"]["BillToLocation"] & components["schemas"]["CustomsInfo"] & components["schemas"]["EmergencyInfo"] & WithRequired<components["schemas"]["LTLRateItems"], "items">;
        /** @description This object shows required fields when the /rates endpoint will be used in conjunction with the /book endpoint. */
        "Rates.LTL.RateToBookRequest": components["schemas"]["Rates.LTL.Request"] & WithRequired<components["schemas"]["OriginLocation"], "originCompany" | "originAddress" | "originCity" | "originState" | "originPostalCode" | "originType" | "originContactName" | "originContactPhone" | "originDockHoursOpen" | "originDockHoursClose"> & WithRequired<components["schemas"]["DestinationLocation"], "destCompany" | "destAddress" | "destCity" | "destState" | "destPostalCode" | "destType"> & components["schemas"]["BillToLocation"] & components["schemas"]["CustomsInfo"] & components["schemas"]["EmergencyInfo"] & WithRequired<components["schemas"]["LTLBookItems"], "items"> & {
        ...
        } & WithRequired<components["schemas"]["ParcelOriginLocation"], "originPostalCode"> & WithRequired<components["schemas"]["ParcelDestinationLocation"], "destPostalCode"> & WithRequired<components["schemas"]["ParcelRateItems"], "items">;
        /** @description This object shows required fields when the /rates endpoint will be used in conjunction with the /book endpoint. */
        "Rates.Parcel.RateToBookRequest": components["schemas"]["Rates.Parcel.Request"] & {
             ...
             */
            schedulePickup: boolean;
        } & WithRequired<components["schemas"]["ParcelOriginLocation"], "originCompany" | "originAddress" | "originCity" | "originState" | "originPostalCode" | "originContactName" | "originContactPhone" | "originDockHoursOpen" | "originDockHoursClose"> & WithRequired<components["schemas"]["ParcelDestinationLocation"], "destCompany" | "destAddress" | "destCity" | "destState" | "destPostalCode" | "destContactName" | "destContactPhone" | "destContactEmail"> & WithRequired<components["schemas"]["ParcelBookItems"], "items">;
        ...
        "Book.Shared.Response": components["schemas"]["Shared.LTL.Shipment"] | components["schemas"]["Shared.Parcel.Shipment"];
        "Shipment.Response": components["schemas"]["Shared.LTL.Shipment"] | components["schemas"]["Shared.Parcel.Shipment"];
        "Search.SearchResults": {
            /** @description An array of shipment objects that match the query parameters. */
            shipments?: (components["schemas"]["Shared.LTL.Shipment"] | components["schemas"]["Shared.Parcel.Shipment"])[];
        ...
        ParcelFreightCollectBookRequest: {
             ...
             * @enum {string}
             */
            serviceId: "ground" | "home_delivery" | "first_overnight" | "priority_overnight" | "standard_overnight" | "two_day_am" | "two_day" | "express_saver" | "next_day" | "next_day_saver" | "next_day_early" | "second_day" | "second_day_am" | "three_day_select";
            /**
             ...
             *      */
            charges?: ("no signature" | "signature required" | "adult signature required" | "indirect signature required" | "residential delivery")[];
            /**
             * Format: date
             * @description Pickup date for the shipment.
             */
            pickupDate?: string;
        } & WithRequired<components["schemas"]["ParcelRateItems"], "items"> & WithRequired<components["schemas"]["ParcelOriginLocation"], "originCompany" | "originAddress" | "originCity" | "originState" | "originPostalCode" | "originContactName" | "originContactPhone" | "originDockHoursOpen" | "originDockHoursClose"> & WithRequired<components["schemas"]["ParcelDestinationLocation"], "destCompany" | "destAddress" | "destCity" | "destState" | "destPostalCode" | "destContactName" | "destContactPhone" | "destContactEmail">;
         ...
         * @enum {string}
         */
        FileTypes: "quote" | "customer-quote" | "bol" | "label" | "label-combined" | "signed bol" | "proof of delivery" | "invoice";
        /**
        ...
        LTLItem: {
            ...
            saidToContainPackagingType?: components["schemas"]["SaidToContainOptions"] | components["schemas"]["FluidSaidToContainOptions"];
            /** @description Indicates the item is stackable. */
            stackable?: boolean;
        };
        /** @enum {string} */
        LTLAccessorial: "arrival notice" | "arrival schedule" | "liftgate pickup" | "liftgate delivery" | "inside pickup" | "inside delivery" | "sort and segregate" | "protect from freezing";
        /** @enum {string} */
        ParcelAccessorial: "signature required" | "adult signature required" | "indirect signature required";
         ...
         * @enum {string}
         */
        LocationType: "business dock" | "business no dock" | "residential" | "limited access" | "trade show" | "construction" | "farm" | "military" | "airport" | "place of worship" | "school" | "mine" | "pier";
        /**
         * @description Packaging types for this item. See [list of LTL packaging types](#section/Packaging-Types)
         * @enum {string}
         */
        LTLPackagingType: "Pallets_48x40" | "Pallets_48x48" | "Pallets_60x48" | "Pallets_other" | "Bags" | "Bales" | "Baskets" | "Boxes" | "Bundles" | "Carpets" | "Cases" | "Coils" | "Crates" | "Cylinders" | "Drums" | "Jerricans" | "Pails" | "Pieces" | "Reels" | "Rolls" | "Totes" | "TubesPipes" | "Unit";
        /**
         * @description Packaging type for this item. See [list of parcel packaging types](#section/Packaging-Types)
         *
         * @enum {string}
         */
        ParcelPackagingType: "Custom" | "FedEx-envelope" | "FedEx-pak" | "FedEx-box" | "FedEx-small-box" | "FedEx-medium-box" | "FedEx-large-box" | "FedEx-extra-large-box" | "FedEx-tube" | "FedEx-10kg-box" | "FedEx-25kg-box" | "UPS-letter" | "UPS-tube" | "UPS-pak" | "UPS-express-box-small" | "UPS-express-box-medium" | "UPS-express-box-large" | "UPS-10kg-box" | "UPS-25kg-box";
        /**
        ...
        HazardousMaterial: {
             ...
             * @enum {string}
             */
            hazardClass?: "1.1A" | "1.1B" | "1.1C" | "1.1D" | "1.1E" | "1.1F" | "1.1G" | "1.1J" | "1.1L" | "1.2B" | "1.2C" | "1.2D" | "1.2E" | "1.2F" | "1.2G" | "1.2H" | "1.2J" | "1.2K" | "1.2L" | "1.3C" | "1.3F" | "1.3G" | "1.3H" | "1.3J" | "1.3K" | "1.3L" | "1.4B" | "1.4C" | "1.4D" | "1.4E" | "1.4F" | "1.4G" | "1.4S" | "1.5D" | "2.1" | "2.2" | "2.3" | "3" | "4.1" | "4.2" | "4.3" | "5.1" | "5.2" | "6.1" | "6.2" | "7" | "8" | "9";
         ...
         * @enum {string}
         */
        SaidToContainOptions: "Bags" | "Bales" | "Baskets" | "Boxes" | "Bundles" | "Carpets" | "Cases" | "Coils" | "Crates" | "Cylinders" | "Drums" | "Jerricans" | "Kegs" | "Pails" | "Pieces" | "Reels" | "Rolls" | "Totes" | "Tubes/Pipes";
        /**
         * @description The package type for "said to contain", when it contains fluid.
         * @enum {string}
         */
        FluidSaidToContainOptions: "Bags" | "Bales" | "Baskets" | "Boxes" | "Bundles" | "Carpets" | "Cases" | "Coils" | "Crates" | "Cylinders" | "Drums" | "gallons" | "Jerricans" | "Kegs" | "liters" | "ounces" | "Pails" | "Pieces" | "Reels" | "Rolls" | "Totes" | "Tubes/Pipes";
