...
describe('validateFreightClass', () => {
    ...
    it('throws an error for invalid freight classes', () => {
        expect(() => validateFreightClass(45)).toThrowError('Invalid freight class');
        expect(() => validateFreightClass(1000)).toThrowError('Invalid freight class');
        expect(() => validateFreightClass(undefined)).toThrowError('Invalid freight class');
      });
});
